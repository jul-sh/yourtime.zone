...
export const getLocalisedInformation = (timestamp, timezone) => {
  ...
  return {
    ...
    daysFromLocalNow: Math.trunc(
      localDate.diff(localNow, 'days').toObject().days
    )
  }
}
